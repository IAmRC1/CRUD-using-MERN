...
import { Avatar, Heart, Share, } from '../assets/svg'
    ...
    .then(data => {
      if(!data.error){
        this.setState({ 
          ...
          return alertInfo('success', 'Animal fetched successfully')
        })
      }
    })
    .catch(err => {
      ...
      <main className="container py-5 view d-flex-center">
        <div className="card shadow-lg">
          ...
          <div className="post-image">
            <img src={post.image} alt="post-image" className="img card-img-top" />
          </div>
          ...
          <div className="action-buttons">
            <a 
              role="button"
              id={post.id}
              className="btn btn-heart btn-outline-danger"
              data-tooltip="Like"
            ...
            <a role="button" className="btn btn-heart btn-outline-info ml-1" data-tooltip="Share" data-tooltip-location="bottom">
